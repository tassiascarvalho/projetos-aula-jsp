...
public class CadastrarAluno extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Receber informações que serão processadas
        
        String nomealuno, cursoaluno;
        Integer idadealuno;
        //nomevariavel = request.getParameter("nameinput");
        nomealuno = request.getParameter("nomealuno");
        cursoaluno = request.getParameter("cursoaluno");        
        ...
        request.getRequestDispatcher("cadastraraluno.jsp").
