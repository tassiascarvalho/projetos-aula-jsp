...
public class ExcluirUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            GenericDAO dao = new UsuarioDAOImpl();//cria instacia da dao e conecta no banco
            dao.excluir(idUsuario);//executa o sql com passagem de parametro
            //Chama o listar
            request.getRequestDispatcher("ListarUsuario").forward(request, response);
        }catch(Exception ex){
            System.out.println("Erro no ServletExcluir \n Erro:" + ex.getMessage());
            ex.printStackTrace();
        }
    }
