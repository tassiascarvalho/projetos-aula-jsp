...
@WebServlet(name = "DadosPublicacao", urlPatterns = {"/DadosPublicacao"})
public class DadosPublicacao extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            System.out.println("Erro no Servlet DadosPublicacao \n Erro: " + ex.getMessage());
            ex.printStackTrace();
        }      
