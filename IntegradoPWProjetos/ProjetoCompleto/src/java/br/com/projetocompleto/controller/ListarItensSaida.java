 ...
 * @author Tassia
 */
@WebServlet(name = "ListarItensSaida", urlPatterns = {"/ListarItensSaida"})
public class ListarItensSaida extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("itenscarrinho", dao.listar());
            request.getRequestDispatcher("produto/itenscarrinho.jsp").forward(request, response);            
        }catch(Exception ex){
            System.out.println("Erro no Servlet ListarItensCarrinho: " + ex.getMessage());
            ex.printStackTrace();
        }
