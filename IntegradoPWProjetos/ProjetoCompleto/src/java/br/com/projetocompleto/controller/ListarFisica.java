 ...
 * @author Tassia
 */
@WebServlet(name = "ListarFisica", urlPatterns = {"/ListarFisica"})
public class ListarFisica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("listafisica", dao.listar());
            request.getRequestDispatcher("fisica/gerenciarfisica.jsp")
                            .forward(request, response);            
        }catch(Exception ex){
            System.out.println("Erro no Servlet ListarFisica: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
