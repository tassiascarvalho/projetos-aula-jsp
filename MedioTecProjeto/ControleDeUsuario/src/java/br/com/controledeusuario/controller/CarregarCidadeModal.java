 ...
 * @author Tassia
 */
@WebServlet(name = "CarregarCidadeModal", urlPatterns = {"/CarregarCidadeModal"})
public class CarregarCidadeModal extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            Cidade oCidadeModal=  new Cidade();
            oCidadeModal = (Cidade) dao.carregar(idcidade);
            
            StringBuilder sb = new StringBuilder("");
            
            sb.append(oCidadeModal.getIdCidade())
              .append(":")
              .append(oCidadeModal.getNomeCidade());
