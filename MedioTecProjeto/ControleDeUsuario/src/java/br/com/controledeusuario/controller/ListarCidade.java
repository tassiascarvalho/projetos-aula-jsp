...
public class ListarCidade extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            GenericDAO daoestado = new EstadoDAOImpl();
            request.setAttribute("estados", daoestado.listar());
            request.getRequestDispatcher("cidade/gerenciarcidade.jsp")
                    .forward(request, response);            
        }catch(Exception ex){
            System.out.println("Erro ao ListarCidade");
            ex.printStackTrace();
        }
    }
