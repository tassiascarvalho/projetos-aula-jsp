 ...
 * @author Aluno
 */
@WebServlet(name = "ListarPessoaF", urlPatterns = {"/ListarPessoaF"})
public class ListarPessoaF extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            request.setAttribute("pessoasf", dao.listar());
            request.getRequestDispatcher("pessoaFisica/listar.jsp").forward(request, response);
        } catch (Exception ex) {
