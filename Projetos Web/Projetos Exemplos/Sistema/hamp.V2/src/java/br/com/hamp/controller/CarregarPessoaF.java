 ...
 * @author Douglas
 */
@WebServlet(name = "CarregarPessoaF", urlPatterns = {"/CarregarPessoaF"})
public class CarregarPessoaF extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("pessoaf", dao.carregar(idPessoa));
