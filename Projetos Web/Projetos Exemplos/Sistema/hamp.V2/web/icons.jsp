	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.jsp"><span>H</span>AMP <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
	...
	<div class="footer_agile_inner_info_w3l">
			...
			<div class="sign-grds">
				...
				<div class="col-md-3 sign-gd flickr-post">
					...
					<ul>
						...
						<li><a href="single.jsp"><img src="images/t21.jpg" alt=" " class="img-responsive" /></a></li>
		...
		<div class="clearfix"></div>
			<div class="agile_newsletter_footer">
				...
				<h3>INSCREVA SEU E-MAIL PARA NOVIDADES</h3>
			</div>
