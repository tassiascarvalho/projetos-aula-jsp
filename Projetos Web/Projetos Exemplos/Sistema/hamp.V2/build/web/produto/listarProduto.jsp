                                    ...
                                    <div class="product-items">
                                        <div class="project-eff" style="padding: 1.5em;">
                                            <div id="nivo-lightbox-demo"> <p> 
                                                    <a href="${pageContext.request.contextPath}/CarregarProduto?idproduto=${produto.idProduto}" data-lightbox-gallery="gallery1" id="nivo-lightbox-demo"><span class="rollover1"> </span> </a></p></div>     
