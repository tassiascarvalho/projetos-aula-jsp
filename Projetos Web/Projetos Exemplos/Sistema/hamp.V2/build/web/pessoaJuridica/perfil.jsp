...
<html>
    <head>
        <title>HAMP EMPRESA - Perfil</title>
                ...
                <div class="mother-grid-inner">
                    ...
                    <div class="page-head_agile_info_w3l">
                        <div class="container">
                            ...
                            <label style="font-weight: 600;  font-size: 3em; color:white; position: relative; left: -10%;text-shadow: 2px 2px 7px black;">PERFIL <i class="fa fa-user"></i></label>
                            <!--/w3_short-->
                ...
                $(window).scroll(function () {
                    ...
                    <div class="inner-block">
                        ...
                        <div class="market-updates">
                            <div class="col-md-3"> <img class="img-rounded img-responsive" src="${pageContext.request.contextPath}/fotos/${pessoaj.imagemPessoaJ}"></div>
                            <div class="col-md-6">
