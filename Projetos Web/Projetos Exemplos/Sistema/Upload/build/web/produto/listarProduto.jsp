...
<html>
    <head>
        <title>HAMP EMPRESA - Produtos</title>
                ...
                <div class="mother-grid-inner">
                    ...
                    <div class="page-head_agile_info_w3l">
                        <div class="container">
                            ...
                            <label style="font-weight: 600;  font-size: 3em; color:white; position: relative; left: -10%;text-shadow: 2px 2px 7px black;">Produtos <i class="fa fa-list"></i></label>
                            <!--/w3_short-->
                            ...
                            <c:forEach items="${produtos}" var="produto" >
                                <div class="col-md-3 product-grid">
                                    <div class="product-items">
                                        <div class="project-eff" style="padding: 1.5em;">
                                            <div id="nivo-lightbox-demo"> <p> <a href="${pageContext.request.contextPath}/CarregarProduto?idproduto=${produto.idProduto}" data-lightbox-gallery="gallery1" id="nivo-lightbox-demo"><span class="rollover1"> </span> </a></p></div>     
                                            <img src="${pageContext.request.contextPath}/produtos/${produto.imagemProduto}" alt="" class="img-responsive">
                                        </div>
                                        <div class="produ-cost" >
                                            <b> <h2 style="font-size: 1.3em; color: white;">${produto.nomeProduto}</h2></b><br>
                                            <b> <h3 style="font-size: 1em;"><label>REF:</label> ${produto.referenciaProduto} </h3></b>
                                            <b> <h3 style="font-size: 1em;"><label>PREÇO:</label> R$ ${produto.valorLocacaoDia} por semana</h3></b>
                                            <b> <h3 style="font-size: 1em;"><label>DISP.:</label> ${produto.disponibilidade} </h3></b>                                       
