 ...
 * @author Aluno
 */
@WebServlet(name = "ExcluirEspecie", urlPatterns = {"/ExcluirEspecie"})
public class ExcluirEspecie extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("ListarEspecie").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas ao excluir Especie!"
                    + "\n Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
