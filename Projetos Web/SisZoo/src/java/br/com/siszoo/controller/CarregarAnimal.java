 ...
 * @author Aluno
 */
@WebServlet(name = "CarregarAnimal", urlPatterns = {"/CarregarAnimal"})
public class CarregarAnimal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            GenericDAO daoEspecie = new EspecieDAOImpl();
            request.setAttribute("especies", daoEspecie.listar());
            GenericDAO dao = new AnimalDAOImpl();
            request.setAttribute("animal", dao.carregar(idAnimal));
