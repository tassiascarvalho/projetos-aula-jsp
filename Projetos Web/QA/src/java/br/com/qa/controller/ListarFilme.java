 ...
 * @author Aluno
 */
@WebServlet(name = "ListarFilme", urlPatterns = {"/ListarFilme"})
public class ListarFilme extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //Lista as classes ao qual se associa
            ...
            request.getRequestDispatcher("Filme/gerenciarfilme.jsp").forward(request, response);
        } catch (Exception ex) {
