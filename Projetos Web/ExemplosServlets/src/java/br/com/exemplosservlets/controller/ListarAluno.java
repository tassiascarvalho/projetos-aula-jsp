 ...
 * @author ferbe
 */
@WebServlet(name = "ListarAluno", urlPatterns = {"/ListarAluno"})
public class ListarAluno extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            try{
                ...
                request.setAttribute("listaalunos", dao.listar());
                request.getRequestDispatcher("gerenciaraluno.jsp").forward(request, response);
                
            }catch(Exception ex){
               System.out.println("Erro Servlet ListarAluno" +ex.getMessage());
                ex.printStackTrace(); 
            }
