 ...
 * @author ferbe
 */
@WebServlet(name = "ListarDisciplina", urlPatterns = {"/ListarDisciplina"})
public class ListarDisciplina extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            try{
                 ...
                 //Recuperar os dados da DAO - BD
                 request.setAttribute("listadisciplinas", dao.listar());
                 request.getRequestDispatcher("gerenciardisciplina.jsp").forward(request, response);
                 
            }catch(Exception ex){
                System.out.println("Erro Servlet ListarDisciplina" +ex.getMessage());
                ex.printStackTrace();
        }
    }
