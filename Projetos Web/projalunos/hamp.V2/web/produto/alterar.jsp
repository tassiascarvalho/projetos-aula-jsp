...
<html>
    <head>
        <title>HAMP EMPRESA - Alterar produto</title>
                ...
                <div class="mother-grid-inner">
                    ...
                    <div class="page-head_agile_info_w3l">
                        <div class="container">
                            ...
                            <label style="font-weight: 600;  font-size: 3em; color:white; position: relative; left: -15%;text-shadow: 2px 2px 7px black;">ALTERAR PRODUTO  <i class="fa fa-shopping-cart"></i></label>
                            <!--/w3_short-->
                ...
                $(window).scroll(function () {
                    ...
                    <div class="inner-block" style="padding-top: 2em;">
                        ...
                        <div class="market-updates">
                            ...
                            <div class="col-md-6">
                                <form method="POST" action="${pageContext.request.contextPath}/AlterarProduto" enctype="multipart/form-data" >
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-9">
                                            ...
                                            <textarea  class="form-control" rows="6"  required name="desc" style="resize: none;">                   
