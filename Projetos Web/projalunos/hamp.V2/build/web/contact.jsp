	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.jsp"><span>H</span>AMP</a></h1>
			</div>
        <!-- header-bot -->
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" menu__item menu__item--current"><a class="menu__link" href="contact.jsp">CONTATO</a></li>
				  </ul>
				</div>
			  </div>
			</nav>	
			...
			<div class="sign-grds">
				...
				<div class="col-md-3 sign-gd flickr-post">
					...
					<ul>
						...
						<li><a href="single.html"><img src="images/t21.jpg" alt=" " class="img-responsive" /></a></li>
