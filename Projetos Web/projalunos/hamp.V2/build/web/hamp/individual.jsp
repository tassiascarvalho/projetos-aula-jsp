        ...
        <div class="page-head_agile_info_w3l">
            ...
            <div class="banner-bootom-w3-agileits">
                    ...
                    <div class="col-md-8 single-right-left simpleCart_shelfItem">
                        ...
                        <form action="${pageContext.request.contextPath}/DadosPedido" method="post">
                            <div class="description">
                                <h5>Data de ínicio da Locação</h5>
                                <jsp:useBean id="now" class="java.util.Date" />
                                <input readonly name="comeco" value="<fmt:formatDate value="${now}" pattern="yyyy-MM-dd" />" type="date" required>

                                <br><br>
                                <h5>Selecione o dia de Témino da Locação</h5>                          
                                <input type="date" name="fim" />

                                <br><br>
                                <span id="btn-calcular" class="btn btn-info">Cálcular Locação</span>
                            </div>
                ...
                <div class="w3_agile_latest_arrivals">
                    <h3 class="wthree_text_info">SUGESTÕES</h3>	
