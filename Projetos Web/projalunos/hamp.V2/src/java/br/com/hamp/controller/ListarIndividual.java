 ...
 * @author Aluno
 */
@WebServlet(name = "ListarIndividual", urlPatterns = {"/ListarIndividual"})
public class ListarIndividual extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int idProduto = Integer.parseInt(request.getParameter("idproduto"));
            try {
                ...
                request.getRequestDispatcher("hamp/individual.jsp").forward(request, response);
            } catch (Exception ex) {
