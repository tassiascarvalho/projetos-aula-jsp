...
public class Enviar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (up.formProcess(getServletContext(), request)) {
            ...
            up.getForm().get("txtNome");
            up.getForm().get("txtEmail");
            request.setAttribute("imagem", up.getFiles().get(0));
            request.setAttribute("email", up.getForm().get("txtEmail"));
            request.setAttribute("nome", up.getForm().get("txtNome"));
