 ...
 * @author Aluno
 */
@WebServlet(name = "CadastrarPessoaFuncionario", urlPatterns = {"/CadastrarPessoaFuncionario"})
public class CadastrarPessoaFuncionario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        pessoa.setEmailPessoa(request.getParameter("email"));
        pessoa.setSenhaPessoa(request.getParameter("senha"));
        pessoa.setStatusPessoa(request.getParameter("statuspessoa"));
        ...
        try {
            ...
            if (request.getParameter("idpessoa").equals("")) {
                ...
                if (dao.alterar(pessoa)) {
                    ...
                    mensagem = "Problemas ao alterar Funcionario";
                }
            }
            request.setAttribute("mensagem", mensagem);
            request.getRequestDispatcher("pessoa/funcionario/cadastrarfuncionario.jsp").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas ao salvar Funcionario!"
                    + "\n Erro:" + ex.getMessage());
            ex.printStackTrace();
        }
    }
