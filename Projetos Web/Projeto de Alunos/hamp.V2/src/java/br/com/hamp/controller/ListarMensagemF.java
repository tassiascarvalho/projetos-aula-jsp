 ...
 * @author Ludi
 */
@WebServlet(name = "ListarMensagemF", urlPatterns = {"/ListarMensagemF"})
public class ListarMensagemF extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            MensagemDAOImpl msg = new MensagemDAOImpl();
            request.setAttribute("mensagens", msg.listarMensagem(idEmissor, idReceptor));
        } catch (Exception ex) {
