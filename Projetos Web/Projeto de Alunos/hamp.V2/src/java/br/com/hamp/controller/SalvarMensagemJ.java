 ...
 * @author Ludi
 */
@WebServlet(name = "SalvarMensagemJ", urlPatterns = {"/SalvarMensagemJ"})
public class SalvarMensagemJ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
         ...
         try {
            MensagemDAOImpl ms = new MensagemDAOImpl();
            request.setAttribute("mensagens", ms.listarMensagem(idEmissor, idReceptor));
        } catch (Exception ex) {
            System.out.println("Erro ao listar mensagem"+ ex.getMessage());
        }
        try {
             PedidoDAOImpl dao = new PedidoDAOImpl();
            request.setAttribute("pedidos", dao.listarPorPessoaJ(idEmissor));
