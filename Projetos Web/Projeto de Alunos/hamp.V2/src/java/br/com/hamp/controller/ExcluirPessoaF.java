 ...
 * @author Ludi
 */
@WebServlet(name = "ExcluirPessoaF", urlPatterns = {"/ExcluirPessoaF"})
public class ExcluirPessoaF extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("ListarPessoaF").forward(request, response);
        } catch (Exception ex) {
