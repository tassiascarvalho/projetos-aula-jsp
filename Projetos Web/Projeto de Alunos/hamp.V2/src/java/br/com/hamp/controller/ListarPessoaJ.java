 ...
 */
@WebServlet(name = "ListarPessoaJ", urlPatterns = {"/ListarPessoaJ"})
public class ListarPessoaJ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("pessoasj", dao.listar());
            request.getRequestDispatcher("pessoaJuridica/listar.jsp").forward(request, response);
        } catch (Exception ex) {
