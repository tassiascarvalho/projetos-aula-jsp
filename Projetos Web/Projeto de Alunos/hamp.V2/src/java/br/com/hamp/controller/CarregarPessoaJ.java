 ...
 * @author Aluno
 */
@WebServlet(name = "CarregarPessoaJ", urlPatterns = {"/CarregarPessoaJ"})
public class CarregarPessoaJ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("pessoaj", dao.carregar(idpessoa)); 
            request.getRequestDispatcher("pessoaJuridica/perfil.jsp").forward(request, response);
        }catch(Exception ex){
            System.out.println("Problemas ao listar Empresa! Erro: "+ex.getMessage());
            ex.printStackTrace();
        }
    }
