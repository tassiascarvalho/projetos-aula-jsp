...
<c:choose>
    <c:when test="${sessionScope.pessoaj != null}">
        <html>
            <head>
                <title>HAMP EMPRESA - Painel de Controle</title>
            ...
            <body>	
                <div class="page-container">	
                        ...
                        <div class="mother-grid-inner">
                            ...
                            <div class="page-head_agile_info_w3l">
                                <div class="container">
                                    ...
                                    <label style="font-weight: 600;  font-size: 3em; color:white; position: relative; left: -20%;text-shadow: 2px 2px 7px black;">PAINEL DE CONTROLE  <i class="fa fa-tachometer"></i></label>
                                    <!--/w3_short-->
                            ...
                            <div class="inner-block">
                                ...
                                <div class="market-updates">
                                    <div class="col-md-4 market-update-gd">
                                        <a href="${pageContext.request.contextPath}/IdProduto?idpessoa=${pessoaj.idPessoa}">
                                            <div class="market-update-block clr-block-1">
                                                ...
                                                <div class="col-md-4 market-update-right">
                                                    <i style="font-size: 90px; color: white;" class="fa fa-plus-circle"> </i>
                                                </div>
                                                <div class="clearfix"> </div>
                                            </div>
                                        </a>
                                    ...
                                    <div class="col-md-4 market-update-gd">
                                        <a href="${pageContext.request.contextPath}/ListarProduto?idempresa=${pessoaj.idPessoa}">
                                            <div class="market-update-block clr-block-1">
                                                <div class="col-md-8 market-update-left">
                                                ...
                                                <div class="col-md-4 market-update-right">
                                                    <i style="font-size: 90px; color: white;" class="fa fa-list"> </i>
                                                </div>
                                                <div class="clearfix"> </div>
                                            </div>
                                        </a>
                                    ...
                                    <div class="col-md-4 market-update-gd">
                                        <a href="${pageContext.request.contextPath}/ListarPedidoJ?idempresa=${pessoaj.idPessoa}">
                                            <div class="market-update-block clr-block-1">
                                                <div class="col-md-8 market-update-left">
                                                    <h3>Ver Pedidos</h3>
                                                    <h4></h4>
                                                ...
                                                <div class="col-md-4 market-update-right">
                                                    <i  style="font-size: 90px; color: white;" class="fa fa-shopping-cart"> </i>
                                                </div>
                                                <div class="clearfix"> </div>
                                            </div>
                                        </a>
                    ...
                    <div class="sidebar-menu">	  
                        <div class="menu">
                            <ul id="menu" >
                                <li id="menu-home" ><a style="font-size: 2em;" href="#"><i class="fa fa-tachometer"></i><span>INÍCIO</span></a></li>
