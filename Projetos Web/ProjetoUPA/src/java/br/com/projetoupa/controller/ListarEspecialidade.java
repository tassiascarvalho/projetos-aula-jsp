 ...
 * @author Tassia
 */
@WebServlet(name = "ListarEspecialidade", urlPatterns = {"/ListarEspecialidade"})
public class ListarEspecialidade extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("medico/gerenciarespecialidade.jsp").forward(request, response);            
        }catch (Exception ex) {
