 ...
 * @author Tassia
 */
@WebServlet(name = "ListarSala", urlPatterns = {"/ListarSala"})
public class ListarSala extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
          ...
          try {
            ...
            request.setAttribute("salas", dao.listar());
            request.getRequestDispatcher("sala/gerenciarsala.jsp").forward(request, response);            
        }catch (Exception ex) {
