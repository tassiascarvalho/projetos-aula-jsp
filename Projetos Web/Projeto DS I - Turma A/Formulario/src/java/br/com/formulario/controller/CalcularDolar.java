 ...
 * @author Tassia
 */
@WebServlet(name = "CalcularDolar", urlPatterns = {"/CalcularDolar"})
public class CalcularDolar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("calculardolar.jsp").forward(request, response);
